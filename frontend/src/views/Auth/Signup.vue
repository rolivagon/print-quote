              ...
              <form @submit.prevent="handleSubmit">
                <div class="space-y-5">
                  ...
                  <div>
                    ...
                    <p v-if="confirmationRequired" class="text-sm text-success-600">
...
const handleSubmit = async () => {
  ...
  if (!agreeToTerms.value) {
    error.value = 'Debes aceptar los términos para crear una cuenta'
    return
  }
  ...
  loading.value = false
  if (signupResult === 'signed_in') {
    router.push('/')
  } else if (signupResult === 'confirmation_required') {
