...
class SQLQuoteRepository(QuoteRepository):
    ...
    def add_item(
        ...
        internal_paper_cost: Decimal | None = None,
        internal_printing_cost: Decimal | None = None,
        internal_finishing_cost: Decimal | None = None,
        internal_cost_total: Decimal | None = None,
        internal_cost_snapshot: dict | None = None,
        ...
        item = QuoteItem(
            ...
            internal_printing_cost=internal_printing_cost,
            internal_finishing_cost=internal_finishing_cost,
            internal_cost_total=internal_cost_total,
            internal_cost_snapshot=internal_cost_snapshot,
